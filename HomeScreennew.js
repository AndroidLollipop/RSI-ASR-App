...
export default class HomeScreen extends React.Component {
  ...
  async renderItemOP(x){
    ...
    fetchData.StateData.SelectedShelf = this.storeData["map"]["shelfMap"][x.shelfLocation][x.shelfColumn]
    this.generateMap()
  }
  ...
  async generateMap(){ //render result map
    ...
    try {
      let hil = this.makeHighlight(fetchData.StateData.SelectedShelf, pma.length)
      this.setState({
        shelfHighlight: hil
      })
    }
